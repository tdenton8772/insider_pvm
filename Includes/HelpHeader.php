...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>PV Measurements Home</title>
        <link href="Styles/HelpSite.css" rel="stylesheet" type="text/css" />
        ...
        <header>
            <div class="content-wrapper">
                <div class="float-left">
                    <p class="site-title"><a href="index.php">PV Measurements Insider</a></p>
                </div>
